...
const contracts = require("../src/index");
...
contract('Unidirectional', accounts => {
    ...
    const channelValue = Units_1.default.convert(1, 'eth', 'wei');
    const settlingPeriod = 0;
    let payment = Units_1.default.convert(0.1, 'eth', 'wei');
    let instance;
    async function createChannelRaw(channelId, _settlingPeriod = settlingPeriod) {
        let options = {
            from: sender,
            value: Units_1.default.convert(1, 'eth', 'wei')
        };
        return instance.open(channelId, receiver, _settlingPeriod, options);
    }
    async function createChannel(settlingPeriod) {
...
//# sourceMappingURL=Unidirectional.test.js.map